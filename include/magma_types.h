...
*/
    ...
    */
    ...
    #define hipblasZgemv(...) magma_unsupported(hipblasZgemv)
    #define hipblasZswap(...) magma_unsupported(hipblasZswap)
    #define hipblasZdscal(...) magma_unsupported(hipblasZdscal)
    #define hipblasZscal(...) magma_unsupported(hipblasZscal)
    ...
    #define hipblasZrotg(...) magma_unsupported(hipblasZrotg)
    #define hipblasZrotc(...) magma_unsupported(hipblasZrotc)
    ...
    #define hipblasZaxpy(...) magma_unsupported(hipblasZaxpy)
    #define hipblasCgemmBatched(...) magma_unsupported(hipblasCgemmBatched)
    #define hipblasDzasum(...) magma_unsupported(hipblasDzasum)
    #define hipblasZcopy(...) magma_unsupported(hipblasZcopy)
    #define hipblasZdotc(...) magma_unsupported(hipblasZdotc)
    #define hipblasZdotu(...) magma_unsupported(hipblasZdotu)
    #define hipblasZrot(...) magma_unsupported(hipblasZrot)
    #define hipblasZtrmv(...) magma_unsupported(hipblasZtrmv)
    #define hipblasZtrsv(...) magma_unsupported(hipblasZtrsv)
    #define hipblasZgemm(...) magma_unsupported(hipblasZgemm)
    ...
    #define hipblasZsyr2k(...) magma_unsupported(hipblasZsyr2k)
    #define hipblasZtrsm(...) magma_unsupported(hipblasZtrsm)
    #define hipblasIdamin(...) magma_unsupported(hipblasIdamin)
    #define hipblasDrot(...) magma_unsupported(hipblasDrot)
    #define hipblasDrotg(...) magma_unsupported(hipblasDrotg)
    #define hipblasDrotm(...) magma_unsupported(hipblasDrotm)
    #define hipblasDrotmg(...) magma_unsupported(hipblasDrotmg)
    #define hipblasDswap(...) magma_unsupported(hipblasDswap)
    #define hipblasDsymv(...) magma_unsupported(hipblasDsymv)
    #define hipblasDsyr(...) magma_unsupported(hipblasDsyr)
    #define hipblasDsyr2(...) magma_unsupported(hipblasDsyr2)
    #define hipblasDtrmv(...) magma_unsupported(hipblasDtrmv)
    #define hipblasDtrsv(...) magma_unsupported(hipblasDtrsv)
    ...
    #define hipblasIcamax(...) magma_unsupported(hipblasIcamax)
    #define hipblasDtrmm(...) magma_unsupported(hipblasDtrmm)
    #define hipblasIcamin(...) magma_unsupported(hipblasIcamin)
    #define hipblasScasum(...) magma_unsupported(hipblasScasum)
    #define hipblasCaxpy(...) magma_unsupported(hipblasCaxpy)
    #define hipblasCcopy(...) magma_unsupported(hipblasCcopy)
    #define hipblasCdotc(...) magma_unsupported(hipblasCdotc)
    #define hipblasCdotu(...) magma_unsupported(hipblasCdotu)
    #define hipblasScnrm2(...) magma_unsupported(hipblasScnrm2)
    #define hipblasCrot(...) magma_unsupported(hipblasCrot)
    #define hipblasCsrot(...) magma_unsupported(hipblasCsrot)
    #define hipblasCrotg(...) magma_unsupported(hipblasCrotg)
    #define hipblasCscal(...) magma_unsupported(hipblasCscal)
    #define hipblasCsscal(...) magma_unsupported(hipblasCsscal)
    #define hipblasCswap(...) magma_unsupported(hipblasCswap)
    #define hipblasCgemv(...) magma_unsupported(hipblasCgemv)
    #define hipblasCgerc(...) magma_unsupported(hipblasCgerc)
    #define hipblasCgeru(...) magma_unsupported(hipblasCgeru)
    #define hipblasIsamin(...) magma_unsupported(hipblasIsamin)
    #define hipblasSrot(...) magma_unsupported(hipblasSrot)
    #define hipblasSrotg(...) magma_unsupported(hipblasSrotg)
    #define hipblasSrotm(...) magma_unsupported(hipblasSrotm)
    #define hipblasSrotmg(...) magma_unsupported(hipblasSrotmg)
    #define hipblasSswap(...) magma_unsupported(hipblasSswap)
    #define hipblasSsymv(...) magma_unsupported(hipblasSsymv)
    #define hipblasSsyr(...) magma_unsupported(hipblasSsyr)
    #define hipblasSsyr2(...) magma_unsupported(hipblasSsyr2)
    #define hipblasStrmv(...) magma_unsupported(hipblasStrmv)
    #define hipblasStrsv(...) magma_unsupported(hipblasStrsv)
    ...
    #define hipblasCgemm(...) magma_unsupported(hipblasCgemm)
    ...
    __device__ __host__ static inline magmaDoubleComplex magmaConj(magmaDoubleComplex p) {
        return MAGMA_Z_MAKE(p.x, -p.y);
    }
    ...
    __device__ __host__ static inline magmaFloatComplex magmaConjf(magmaFloatComplex p) {
        return MAGMA_C_MAKE(p.x, -p.y);
    }
