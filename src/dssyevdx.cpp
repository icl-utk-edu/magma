    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    if ( n <= 1 ) {
        ...
        lwmin  = max( 2*n + n*nb, 1 + 6*n + 2*n*n ) + 2 * n + n * n;
        liwmin = 3 + 5*n;
    }
    else {
        lwmin  = 2*n + n*nb;
    ...
    float *floatA = (float*)(work+indfloatA);
    float *floatd = (float*)(work+indfloatd);
    float *floate = (float*)(work+indfloate);
    double *d = (double*)floatd;
    double *e = work + inde;
    ...
    magma_ssytrd(uplo, n, floatA, lda, floatd, floate,
                 (float*)&work[indtau], (float*)&work[indwrk], llwork, &iinfo);
    ...
    magmablas_slaset( MagmaFull, n, n, MAGMA_S_ZERO, MAGMA_S_ONE, dfloatQ, ldr, queue );
    magma_sormtr_gpu( MagmaLeft, uplo, MagmaNoTrans, n, n, dfloatA, ldda, (float*)&work[indtau],
    ...
    magma_dsetmatrix( n, *m, &work[indwrk + n * (il-1)], n, dX, ldr, queue);
