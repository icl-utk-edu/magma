    ...
    sycl::range<3> grid(1, dimgrid2, dimgrid1);
        ...
        if ( alignment == 1) {
            if (beta == MAGMA_Z_ZERO) {
                zgesellptmv2d_kernel_1<true><<< grid2, block, Ms, queue->sycl_stream() >>>
                ( m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, dx, beta, dy );
            } else {
                zgesellptmv2d_kernel_1<false><<< grid, block, Ms, queue->sycl_stream() >>>
                ( m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, dx, beta, dy );
            }
        } else if ( alignment == 4){
            if (beta == MAGMA_Z_ZERO) {
                zgesellptmv2d_kernel_4_tex<true><<< grid, block, Ms, queue->sycl_stream() >>>
                ( m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, texdx, beta, dy );
            } else {
                zgesellptmv2d_kernel_4_tex<false><<< grid, block, Ms, queue->sycl_stream() >>>
                ( m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, texdx, beta, dy );
            }
        }
            ...
            if (beta == MAGMA_Z_ZERO) {
                zgesellptmv2d_kernel_8_tex<true><<< grid, block, Ms, queue->sycl_stream() >>>
                ( m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, texdx, beta, dy );
            } else {
                zgesellptmv2d_kernel_8_tex<false><<< grid, block, Ms, queue->sycl_stream() >>>
                ( m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, texdx, beta, dy );
            }
        }
            ...
            if (beta == MAGMA_Z_ZERO) {
                zgesellptmv2d_kernel_16_tex<true><<< grid, block, Ms, queue->sycl_stream() >>>
                ( m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, texdx, beta, dy );
            } else {
                zgesellptmv2d_kernel_16_tex<false><<< grid, block, Ms, queue->sycl_stream() >>>
                ( m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, texdx, beta, dy );
            }
        }
            ...
            if (beta == MAGMA_Z_ZERO) {
                zgesellptmv2d_kernel_32_tex<true><<< grid, block, Ms, queue->sycl_stream() >>>
                ( m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, texdx, beta, dy );
            } else {
                zgesellptmv2d_kernel_32_tex<false><<< grid, block, Ms, queue->sycl_stream() >>>
                ( m, n, blocksize, alignment, alpha,
                    dval, dcolind, drowptr, texdx, beta, dy );
            }
        }
