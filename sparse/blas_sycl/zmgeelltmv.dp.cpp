        ...
        uint8_t *dpct_local)
{
    ...
    if(row < num_rows ) {
        for( int i=0; i<num_vecs; i++ )
            dot[item_ct1.get_local_id(2) + i * item_ct1.get_local_range(2)] = MAGMA_Z_ZERO;
    ...
    magma_queue_t queue )
{
    ...
    /*
    DPCT1083:424: The size of local memory in the migrated code may be different
    ...
    */
    ...
    /*
    DPCT1064:422: Migrated make_cuDoubleComplex call is used in a macro
