    ...
    magma_queue_t queue )
{
    ...
    */
    ...
    /*
    DPCT1049:757: The work-group size passed to the SYCL kernel may exceed the
    ...
    magma_queue_t queue )
{
    ...
    sycl::range<3> Gs_next(1, 1, 1);
    /*
    DPCT1083:782: The size of local memory in the migrated code may be different
    from the original code. Check that the allocated memory size in the migrated
    code is correct.
    */
    ...
    sycl::range<3> Gs2(1, 1, 1);
    /*
    DPCT1049:780: The work-group size passed to the SYCL kernel may exceed the
    limit. To get the device limit, query info::device::max_work_group_size.
    Adjust the work-group size if needed.
    */
    ((sycl::queue *)(queue->sycl_stream()))
    ...
    magma_queue_t queue )
{
    ...
    */
    ...
    int b = 1;
    /*
    DPCT1049:794: The work-group size passed to the SYCL kernel may exceed the
    limit. To get the device limit, query info::device::max_work_group_size.
    Adjust the work-group size if needed.
    */
    ...
    sycl::range<3> Gs2(1, 1, 1);
    /*
    DPCT1049:796: The work-group size passed to the SYCL kernel may exceed the
    limit. To get the device limit, query info::device::max_work_group_size.
    Adjust the work-group size if needed.
    */
    ((sycl::queue *)(queue->sycl_stream()))
