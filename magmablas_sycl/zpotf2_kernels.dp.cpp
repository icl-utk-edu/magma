        ...
        magma_int_t *info_array, magma_int_t batchCount, magma_queue_t queue)
{
    ...
    */
    ...
    if( n % POTF2_NB == 0){
        /*
        DPCT1049:1315: The work-group size passed to the SYCL kernel may exceed
        ...
        */
        ...
        /*
        DPCT1049:1317: The work-group size passed to the SYCL kernel may exceed
        the limit. To get the device limit, query
        info::device::max_work_group_size. Adjust the work-group size if needed.
        */
        ((sycl::queue *)(queue->cuda_stream()))
        ...
        magma_int_t *dinfo, magma_queue_t queue)
{
    ...
    */
    ...
    if( n % POTF2_NB == 0){
        /*
        DPCT1049:1321: The work-group size passed to the SYCL kernel may exceed
        the limit. To get the device limit, query
        info::device::max_work_group_size. Adjust the work-group size if needed.
        */
        ((sycl::queue *)(queue->cuda_stream()))
        ...
        /*
        DPCT1049:1323: The work-group size passed to the SYCL kernel may exceed
        the limit. To get the device limit, query
        info::device::max_work_group_size. Adjust the work-group size if needed.
        */
        ((sycl::queue *)(queue->cuda_stream()))
