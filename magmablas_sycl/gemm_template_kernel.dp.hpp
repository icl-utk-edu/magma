...
void gemm_template_nn_kernel(
    ...
    T const * B, int LDB,
    T*        C, int LDC,
    T alpha, T beta , const sycl::nd_item<3> &item_ct1, uint8_t*dpct_local)
{
            ...
            ->submit([&](sycl::handler &cgh) {
                ...
                cgh.parallel_for(
                    ...
                    [=](sycl::nd_item<3> item_ct1) {
                        gemm_template_nn_kernel<T, DIM_X, DIM_Y, BLK_M, BLK_N,
                                                BLK_K, DIM_XA, DIM_YA, DIM_XB,
                                                DIM_YB, CONJA, CONJB>(
        ...
        ((sycl::queue *)(queue->sycl_stream()))
            ->submit([&](sycl::handler &cgh) {
                ...
                cgh.parallel_for(
                    sycl::nd_range<3>(dimGrid * dimBlock, dimBlock),
                    [=](sycl::nd_item<3> item_ct1) {
                        gemm_template_nt_kernel<T, DIM_X, DIM_Y, BLK_M, BLK_N,
                                                BLK_K, DIM_XA, DIM_YA, DIM_XB,
                                                DIM_YB, CONJA, CONJB>(
                            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
                            item_ct1,
        ...
        ((sycl::queue *)(queue->sycl_stream()))
            ->submit([&](sycl::handler &cgh) {
                ...
                cgh.parallel_for(
                    sycl::nd_range<3>(dimGrid * dimBlock, dimBlock),
                    [=](sycl::nd_item<3> item_ct1) {
                        gemm_template_tn_kernel<T, DIM_X, DIM_Y, BLK_M, BLK_N,
                                                BLK_K, DIM_XA, DIM_YA, DIM_XB,
                                                DIM_YB, CONJA, CONJB>(
                            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
                            item_ct1,
        ...
        ((sycl::queue *)(queue->sycl_stream()))
            ->submit([&](sycl::handler &cgh) {
                ...
                cgh.parallel_for(
                    sycl::nd_range<3>(dimGrid * dimBlock, dimBlock),
                    [=](sycl::nd_item<3> item_ct1) {
                        gemm_template_tt_kernel<T, DIM_X, DIM_Y, BLK_M, BLK_N,
                                                BLK_K, DIM_XA, DIM_YA, DIM_XB,
                                                DIM_YB, CONJA, CONJB>(
                            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
                            item_ct1,
