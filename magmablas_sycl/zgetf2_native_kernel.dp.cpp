...
zgetf2_native_kernel( int m, int n,
                      ...
                      magmaDoubleComplex *sreg, uint8_t *padding)
{
    ...
    magma_queue_t queue )
{
    ...
    sycl::range<3> threads(1, 1, ZGETF2_FUSED_NTH);
    ...
    shmem = shmem - ntx * sizeof(magmaDoubleComplex) - ntx * sizeof(double) - ntx * sizeof(int);
      ...
      ((sycl::queue *)(queue->sycl_stream()))
            ->submit([&](sycl::handler &cgh) {
                ...
                sycl::local_accessor<uint8_t, 1>
                    spadding_acc_ct1(sycl::range<1>(shmem), cgh);
