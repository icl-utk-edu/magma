    ...
    sycl::accessor<magmaDoubleComplex, 2, sycl::access_mode::read_write, sycl::access::target::local> sA)
{
    ...
    for( int tile=0; tile < NB/NX; ++tile ) {
        ...
        /*
        DPCT1065:1400: Consider replacing sycl::nd_item::barrier() with
        ...
        */
        ...
        /*
        DPCT1065:1401: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
...
void ztranspose_conj_kernel(
    ...
    sycl::accessor<magmaDoubleComplex, 2, sycl::access_mode::read_write, sycl::access::target::local> sA)
{
    ztranspose_conj_device(m, n, A, lda, AT, ldat, item_ct1, sA);
}
    ...
    sycl::accessor<magmaDoubleComplex, 2, sycl::access_mode::read_write, sycl::access::target::local> sA)
{
    ...
    ztranspose_conj_device(m, n, dA_array[batchid], lda, dAT_array[batchid],
                           ldat, item_ct1, sA);
}
    ...
    magma_queue_t queue )
{
    ...
    /*
    DPCT1049:1402: The work-group size passed to the SYCL kernel may exceed the
    ...
    ((sycl::queue *)(queue->cuda_stream()))->submit([&](sycl::handler &cgh) {
        ...
        cgh.parallel_for(sycl::nd_range<3>(grid * threads, threads),
                         [=](sycl::nd_item<3> item_ct1) {
                             ztranspose_conj_kernel(m, n, dA, ldda, dAT, lddat,
                                                    item_ct1, sA_acc_ct1);
                         });
    });
}
    ...
    magma_int_t batchCount, magma_queue_t queue )
{
    ...
    for(magma_int_t i = 0; i < batchCount; i+=max_batchCount) {
        ...
        /*
        DPCT1049:1403: The work-group size passed to the SYCL kernel may exceed
        ...
        */
        ((sycl::queue *)(queue->cuda_stream()))
            ->submit([&](sycl::handler &cgh) {
                ...
                cgh.parallel_for(sycl::nd_range<3>(grid * threads, threads),
                                 [=](sycl::nd_item<3> item_ct1) {
                                     ztranspose_conj_kernel_batched(
                                         m, n, dA_array + i, ldda,
