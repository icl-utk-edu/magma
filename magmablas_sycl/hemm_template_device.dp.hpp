    ...
    sycl::accessor<T, 2, sycl::access_mode::read_write, sycl::access::target::local> sB)
{
    ...
    const int bx = item_ct1.get_group(2); // block's m dimension
    const int by = item_ct1.get_group(1); // block's n dimension
    ...
    for (int n = 0; n < THR_N; n++)
        ...
        for (int m = 0; m < THR_M; m++)
            /*
            DPCT1064:810: Migrated make_cuDoubleComplex call is used in a macro
    ...
    if(part_2 > 0){
        ...
        for (int n = 0; n < BLK_M; n += DIM)
            ...
            for (int m = 0; m < BLK_M; m += DIM)
                sA[n+ty][m+tx] = fetch(A, m, n, boundA);
        /*
        DPCT1065:813: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
        ...
        /*
        DPCT1065:814: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
        ...
        /*
        DPCT1065:815: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
    ...
    for (kk = 0; kk < part_3-BLK_M; kk += BLK_M){
        ...
        /*
        DPCT1065:816: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
        ...
        /*
        DPCT1065:817: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
    ...
    /*
    DPCT1065:809: Consider replacing sycl::nd_item::barrier() with
    ...
    sycl::accessor<T, 2, sycl::access_mode::read_write, sycl::access::target::local> sB)
{
    ...
    for (int n = 0; n < THR_N; n++)
        ...
        for (int m = 0; m < THR_M; m++)
            /*
            DPCT1064:819: Migrated make_cuDoubleComplex call is used in a macro
            definition and is not valid for all macro uses. Adjust the code.
            */
            rC[n][m] = make_FloatingPoint(0.0, 0.0);
    ...
    for (kk = 0; kk < part_1; kk += BLK_M)
    {
        ...
        /*
        DPCT1065:820: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
        ...
        /*
        DPCT1065:821: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
    ...
    if(part_2 > 0){
        ...
        for (int n = 0; n < BLK_M; n += DIM)
            ...
            for (int m = 0; m < BLK_M; m += DIM)
                sA[n+ty][m+tx] = fetch(A, m, n, boundA);
        /*
        DPCT1065:822: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
        ...
        for (int n = 0; n < BLK_M; n += DIM){
            if(ty < tx){
                ...
                /*
                DPCT1064:827: Migrated make_cuDoubleComplex call is used in a
                macro definition and is not valid for all macro uses. Adjust the
                code.
                */
                sA[n + ty][n + tx] =
                    make_FloatingPoint(real(sA[n + ty][n + tx]), 0.0);
            }
            #pragma unroll
            for (int m = n+DIM; m < BLK_M; m += DIM)
        ...
        /*
        DPCT1065:823: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
    ...
    for (kk = 0; kk < part_3-BLK_M; kk += BLK_M){
        ...
        /*
        DPCT1065:825: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
    ...
    /*
    DPCT1065:818: Consider replacing sycl::nd_item::barrier() with
    sycl::nd_item::barrier(sycl::access::fence_space::local_space) for better
    performance if there is no access to global memory.
    */
    item_ct1.barrier();
    ...
    sycl::accessor<T, 2, sycl::access_mode::read_write, sycl::access::target::local> sB)
{
    ...
    for (int n = 0; n < THR_N; n++)
        ...
        for (int m = 0; m < THR_M; m++)
            /*
            DPCT1064:829: Migrated make_cuDoubleComplex call is used in a macro
            definition and is not valid for all macro uses. Adjust the code.
            */
            rC[n][m] = make_FloatingPoint(0.0, 0.0);
    ...
    if(part_2 > 0){
        ...
        */
        ...
        for (int n = 0; n < BLK_N; n += DIM){
            if(ty > tx){
                ...
                /*
                DPCT1064:837: Migrated make_cuDoubleComplex call is used in a
                macro definition and is not valid for all macro uses. Adjust the
                code.
                */
                sA[n + ty][n + tx] =
        ...
        */
        ...
        /*
        DPCT1065:834: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
    ...
    for (kk = 0; kk < part_3-BLK_N; kk += BLK_N){
        ...
        /*
        DPCT1065:835: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
        ...
        /*
        DPCT1065:836: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
    ...
    sycl::accessor<T, 2, sycl::access_mode::read_write, sycl::access::target::local> sB)
{
    ...
    for (int n = 0; n < THR_N; n++)
        ...
        for (int m = 0; m < THR_M; m++)
            /*
            DPCT1064:839: Migrated make_cuDoubleComplex call is used in a macro
            definition and is not valid for all macro uses. Adjust the code.
            */
            rC[n][m] = make_FloatingPoint(0.0, 0.0);
    ...
    for (kk = 0; kk < part_1; kk += BLK_N){
        ...
        /*
        DPCT1065:840: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
        ...
        /*
        DPCT1065:841: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
    ...
    if(part_2 > 0){
        ...
        for (int n = 0; n < BLK_N; n += DIM)
            ...
            for (int m = 0; m < BLK_N; m += DIM)
                sA[n+ty][m+tx] = fetch(A, m, n, boundA);
        /*
        DPCT1065:842: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
        ...
        /*
        DPCT1065:843: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
        ...
        /*
        DPCT1065:844: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
    ...
    for (kk = 0; kk < part_3-BLK_N; kk += BLK_N){
        ...
        /*
        DPCT1065:845: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
        ...
        /*
        DPCT1065:846: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
    ...
    /*
    DPCT1065:838: Consider replacing sycl::nd_item::barrier() with
    sycl::nd_item::barrier(sycl::access::fence_space::local_space) for better
    performance if there is no access to global memory.
    */
    item_ct1.barrier();
