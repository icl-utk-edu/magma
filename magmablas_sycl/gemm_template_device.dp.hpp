...
template <typename T, const int DIM_X, const int DIM_Y, const int BLK_M,
          const int BLK_N, const int BLK_K, const int DIM_XA, const int DIM_YA,
          const int DIM_XB, const int DIM_YB, const int THR_M, const int THR_N,
          const int CONJA, const int CONJB>
static void gemm_template_device_nn(int M, int N, int K,
                                    const T *__restrict__ A, int LDA,
                                    const T *__restrict__ B, int LDB,
                                    T *__restrict__ C, int LDC, T alpha, T beta,
                                    T *sA, int slda, T *sB, int sldb, T *sC,
                                    int sldc, const sycl::nd_item<3> &item_ct1)
{
    int tx = item_ct1.get_local_id(2); // thread's m dimension
    int ty = item_ct1.get_local_id(1); // thread's n dimension
    ...
    int bx = item_ct1.get_group(2); // block's m dimension
    int by = item_ct1.get_group(1); // block's n dimension
...
template <typename T, const int DIM_X, const int DIM_Y, const int BLK_M,
          ...
          const int DIM_XB, const int DIM_YB, const int THR_M, const int THR_N,
          const int CONJA, const int CONJB>
static void gemm_template_device_nt(int M, int N, int K,
                                    const T *__restrict__ A, int LDA,
                                    const T *__restrict__ B, int LDB,
                                    T *__restrict__ C, int LDC, T alpha, T beta,
                                    T *sA, int slda, T *sB, int sldb, T *sC,
...
template <typename T, const int DIM_X, const int DIM_Y, const int BLK_M,
          ...
          const int DIM_XB, const int DIM_YB, const int THR_M, const int THR_N,
          const int CONJA, const int CONJB>
static void gemm_template_device_tn(int M, int N, int K,
                                    const T *__restrict__ A, int LDA,
                                    const T *__restrict__ B, int LDB,
                                    T *__restrict__ C, int LDC, T alpha, T beta,
                                    T *sA, int slda, T *sB, int sldb, T *sC,
...
template <typename T, const int DIM_X, const int DIM_Y, const int BLK_M,
          ...
          const int DIM_XB, const int DIM_YB, const int THR_M, const int THR_N,
          const int CONJA, const int CONJB>
static void gemm_template_device_tt(int M, int N, int K,
                                    const T *__restrict__ A, int LDA,
                                    const T *__restrict__ B, int LDB,
                                    T *__restrict__ C, int LDC, T alpha, T beta,
                                    T *sA, int slda, T *sB, int sldb, T *sC,
