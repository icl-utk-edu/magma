    ...
    magma_queue_t queue)
{
    ...
    /*
    DPCT1064:1457: Migrated make_cuDoubleComplex call is used in a macro
    ...
    */
    ...
    /*
    DPCT1064:1458: Migrated make_cuDoubleComplex call is used in a macro
    definition and is not valid for all macro uses. Adjust the code.
    */
    magma_zsetvector_const(total_size_dinvA, dinvA, MAGMA_Z_MAKE(0.0, 0.0),
                           queue);
