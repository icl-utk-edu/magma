...
*******************************************************************************/
void
magmablas_sgemm_packed_batched_core(
    ...
    magma_int_t batchCount, magma_queue_t queue )
{
    ...
    else if (transA == MagmaConjTrans && uplo == MagmaLower)   { shape = 2; } // cn with lower
    else if (transA == MagmaConjTrans && uplo == MagmaUpper)   { shape = 3; } // cn with upper
        ...
        case 0: // nn with lower
            {
                ...
                {
                    if (k == 8 && n == 24)
                        gemm_lower_packed_template_batched_nn<float, version(NN,512), 0, 0>
                        (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                    else if (n < 32)
                        gemm_lower_packed_template_batched_nn<float, version(NN,510), 0, 0>
                        (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                    else
                        gemm_lower_packed_template_batched_nn<float, version(NN,504), 0, 0>
                        (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                }
                else
                {
                    gemm_lower_packed_template_batched_nn<float, version(NN,518), 0, 0>
                    (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                }
            }
            break;
        case 1: // nn with upper
            {
                ...
                {
                    if (k == 8 && n == 24)
                        gemm_upper_packed_template_batched_nn<float, version(NN,512), 0, 0>
                        (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                    else if (n < 32)
                        gemm_upper_packed_template_batched_nn<float, version(NN,510), 0, 0>
                        (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                    else
                        gemm_upper_packed_template_batched_nn<float, version(NN,504), 0, 0>
                        (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                }
                else
                {
                    gemm_upper_packed_template_batched_nn<float, version(NN,518), 0, 0>
                    (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                }
            }
            break;
        case 2: // tn with lower
            {
                if(m == n && m < 32) {
                    if(m <= 8) {
                        gemm_lower_packed_template_batched_tn<float, 8, 8, 8, 8, 32, 1, 8, 8, 8, 8, 0, 0>
                        (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                    }
                    else if(m <= 16) {
                        gemm_lower_packed_template_batched_tn<float, 16, 4, 16, 16, 16, 1, 16, 4, 16, 4, 0, 0>
                        (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                    }
                    else if (m <= 24) {
                        gemm_lower_packed_template_batched_tn<float, 8, 8, 24, 24, 16, 1, 8, 8, 8, 8, 0, 0>
                        (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                    }
                    else {
                        gemm_lower_packed_template_batched_tn<float, 16, 8, 32, 32, 64, 1, 16, 8, 16, 8, 0, 0>
                        (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                    }
                }
                else if (k < 64) {
                    gemm_lower_packed_template_batched_tn<float, version(TN,654), 0, 0>
                    (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                }
                else {
                    gemm_lower_packed_template_batched_tn<float, version(TN,666), 0, 0>
                    (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                }
            }
            break;
        case 3: // tn with upper
            {
                if(m == n && m < 32) {
                    if(m <= 8) {
                        gemm_upper_packed_template_batched_tn<float, 8, 8, 8, 8, 32, 1, 8, 8, 8, 8, 0, 0>
                        (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                    }
                    else if(m <= 16) {
                        gemm_upper_packed_template_batched_tn<float, 16, 4, 16, 16, 16, 1, 16, 4, 16, 4, 0, 0>
                        (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                    }
                    else if (m <= 24) {
                        gemm_upper_packed_template_batched_tn<float, 8, 8, 24, 24, 16, 1, 8, 8, 8, 8, 0, 0>
                        (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                    }
                    else {
                        gemm_upper_packed_template_batched_tn<float, 16, 8, 32, 32, 64, 1, 16, 8, 16, 8, 0, 0>
                        (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                    }
                }
                else if (k < 64) {
                    gemm_upper_packed_template_batched_tn<float, version(TN,654), 0, 0>
                    (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                }
                else {
                    gemm_upper_packed_template_batched_tn<float, version(TN,666), 0, 0>
                    (m, n, k, dA_array, ldda, dB_array, lddb, dC_array, lddc, alpha, beta, Ai, Aj, Bi, Bj, Ci, Cj, batchCount, queue);
                }
            }
            break;
