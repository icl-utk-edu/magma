    ...
    magma_int_t batchCount, magma_queue_t queue)
{
    if ( trans == MagmaNoTrans ) {
        if (max(m, n) <= 96) { // small size
            if (m < n) { // Fat matrix
                if ( m <= 8) {
                    gemvn_packed_template_batched<magmaDoubleComplex, version(N, 72)>
                    ( m, n, alpha, dA_array, dA, ldda, strideA, Ai, Aj, dx_array, dx, incx, stridex, xi, beta, dy_array, dy, incy, stridey, yi, batchCount, queue );
                }
                else if ( m <= 32) {
                    gemvn_packed_template_batched<magmaDoubleComplex, version(N, 100)>
                    ( m, n, alpha, dA_array, dA, ldda, strideA, Ai, Aj, dx_array, dx, incx, stridex, xi, beta, dy_array, dy, incy, stridey, yi, batchCount, queue );
                }
                else if ( m <= 64) {
                    gemvn_packed_template_batched<magmaDoubleComplex, version(N, 121)>
                    ( m, n, alpha, dA_array, dA, ldda, strideA, Ai, Aj, dx_array, dx, incx, stridex, xi, beta, dy_array, dy, incy, stridey, yi, batchCount, queue );
                }
                else {
                    gemvn_packed_template_batched<magmaDoubleComplex, version(N, 132)>
                    ( m, n, alpha, dA_array, dA, ldda, strideA, Ai, Aj, dx_array, dx, incx, stridex, xi, beta, dy_array, dy, incy, stridey, yi, batchCount, queue );
                }
            } else {   // Tall or square matrix
                if ( n <= 16) {
                    gemvn_packed_template_batched<magmaDoubleComplex, version(N, 129)>
                    ( m, n, alpha, dA_array, dA, ldda, strideA, Ai, Aj, dx_array, dx, incx, stridex, xi, beta, dy_array, dy, incy, stridey, yi, batchCount, queue );
                }
                else if ( n <= 64) {
                    gemvn_packed_template_batched<magmaDoubleComplex, version(N, 131)>
                    ( m, n, alpha, dA_array, dA, ldda, strideA, Ai, Aj, dx_array, dx, incx, stridex, xi, beta, dy_array, dy, incy, stridey, yi, batchCount, queue );
                }
                else {
                    gemvn_packed_template_batched<magmaDoubleComplex, version(N, 132)>
            ...
            if (m < n) { // Fat matrix
                if (m <= 16) {
                    ...
                    gemvn_packed_template_batched<magmaDoubleComplex, version(N, 116)>
                    ( m, n, alpha, dA_array, dA, ldda, strideA, Ai, Aj, dx_array, dx, incx, stridex, xi, beta, dy_array, dy, incy, stridey, yi, batchCount, queue );
                }
                else {
                    gemvn_packed_template_batched<magmaDoubleComplex, version(N, 133)>
                    ( m, n, alpha, dA_array, dA, ldda, strideA, Ai, Aj, dx_array, dx, incx, stridex, xi, beta, dy_array, dy, incy, stridey, yi, batchCount, queue );
                }
            }
            else { // Tall or square matrix
                if (m <= 256) {
                    gemvn_packed_template_batched<magmaDoubleComplex, version(N, 137)>
                    ( m, n, alpha, dA_array, dA, ldda, strideA, Ai, Aj, dx_array, dx, incx, stridex, xi, beta, dy_array, dy, incy, stridey, yi, batchCount, queue );
                }
                else {
                    gemvn_packed_template_batched<magmaDoubleComplex, version(N, 140)>
                    ( m, n, alpha, dA_array, dA, ldda, strideA, Ai, Aj, dx_array, dx, incx, stridex, xi, beta, dy_array, dy, incy, stridey, yi, batchCount, queue );
                }
            }
        }// big size
        ...
        if (max(m, n) <= 96) { // small size
            if (n <= 16) {
                gemvc_packed_template_batched<magmaDoubleComplex, version(T, 42)>
                ...
                gemvc_packed_template_batched<magmaDoubleComplex, version(T, 46)>
                ( trans, m, n, alpha, dA_array, dA, ldda, strideA, Ai, Aj, dx_array, dx, incx, stridex, xi, beta, dy_array, dy, incy, stridey, yi, batchCount, queue );
            }
        }
        else { // big size
            if (m <= n) { // Fat or square matrix
                if (m <= 64) {
                    gemvc_packed_template_batched<magmaDoubleComplex, version(T, 47)>
                    ( trans, m, n, alpha, dA_array, dA, ldda, strideA, Ai, Aj, dx_array, dx, incx, stridex, xi, beta, dy_array, dy, incy, stridey, yi, batchCount, queue );
                }
                else {
                    gemvc_packed_template_batched<magmaDoubleComplex, version(T, 46)>
            ...
            {
                if (n <= 8) {
                    gemvc_packed_template_batched<magmaDoubleComplex, version(T, 130)>
                    ( trans, m, n, alpha, dA_array, dA, ldda, strideA, Ai, Aj, dx_array, dx, incx, stridex, xi, beta, dy_array, dy, incy, stridey, yi, batchCount, queue );
                }
                else {
                    gemvc_packed_template_batched<magmaDoubleComplex, version(T, 46)>
