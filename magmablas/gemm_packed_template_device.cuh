...
static __device__
void gemm_lower_packed_template_device_nn(
    int M, int N, int K,
...
template<typename T, const int DIM_X, const int DIM_Y, const int BLK_M, const int BLK_N, const int BLK_K,
         ...
         const int THR_M, const int THR_N, const int CONJA, const int CONJB>
static __device__
void gemm_lower_packed_template_device_tn (
    int M, int N, int K,
    const T* __restrict__ A, int coffA, int roffA, int LDA,
    const T* __restrict__ B, int coffB, int roffB, int LDB,
    T*       __restrict__ C, int LDC,
...
template<typename T, const int DIM_X, const int DIM_Y, const int BLK_M, const int BLK_N, const int BLK_K,
         ...
         const int THR_M, const int THR_N, const int CONJA, const int CONJB>
static __device__
void gemm_upper_packed_template_device_nn(
    int M, int N, int K,
    const T* __restrict__ A, int coffA, int roffA, int LDA,
    const T* __restrict__ B, int coffB, int roffB, int LDB,
    T*       __restrict__ C, int LDC,
...
template<typename T, const int DIM_X, const int DIM_Y, const int BLK_M, const int BLK_N, const int BLK_K,
         ...
         const int THR_M, const int THR_N, const int CONJA, const int CONJB>
static __device__
void gemm_upper_packed_template_device_tn(
    int M, int N, int K,
    const T* __restrict__ A, int coffA, int roffA, int LDA,
    const T* __restrict__ B, int coffB, int roffB, int LDB,
    T*       __restrict__ C, int LDC,
