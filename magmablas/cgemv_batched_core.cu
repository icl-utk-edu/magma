...
magmablas_cgemv_batched_core(
    ...
    magmaFloatComplex_ptr dA_array[], magmaFloatComplex_ptr dA, magma_int_t ldda, magma_int_t strideA,
    magmaFloatComplex_ptr dx_array[], magmaFloatComplex_ptr dx, magma_int_t incx, magma_int_t stridex,
    magmaFloatComplex beta,
    magmaFloatComplex_ptr dy_array[], magmaFloatComplex_ptr dy, magma_int_t incy, magma_int_t stridey,
